...
update msg model =
    case msg of
        ...
        GotPackages result ->
            let _ = Debug.log "Search update" result in
            case result of
                Err _ ->
...
view model =
    let _ = Debug.log "Search view" "" in
    { title = "Elm Packages"
    , header = []
            ...
            Success es ->
                ...
                div []
                    ...
                    , p [ class "pkg-hint" ]
                        ...
                        , a [ href "https://gist.github.com" ] [ text "technical reasons" ]
                        , text ", search"
                        , a [ href "https://dmy.github.io" ] [ text "here" ]
                        , text "instead!"
                        ]
                    ]
        ]
