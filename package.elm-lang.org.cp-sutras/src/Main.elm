...
import Page.Search.Entry exposing (search)
...
view model =
    case model.page of
        ...
        Search search ->
            let _ = Debug.log "Main view" search in
            Skelton.view SearchMsg (Search.view search)

        Docs docs ->
            Skelton.view DocsMsg (Docs.view docs)

        Diff diff ->
            Skelton.view never (Diff.view diff)

        Help help ->
            Skelton.view never (Help.view help)
...
update message model =
    case message of
        ...
        SearchMsg msg ->
            let _ = Debug.log "Main update" message in
            case model.page of
                Search search ->
        ...
        HelpMsg msg ->
            case model.page of
                Help help ->
                    stepHelp model (Help.update msg help)
...
stepSearch model ( search, cmds ) =
    let _ = Debug.log "Main stepSearch" search in
        ...
        parser =
            oneOf
                ...
                , route (s "help" </> s "design-guidelines")
                    (stepHelp model (Help.init session "Desing Guidelines" "/assets/help/design-guidelines.md"))
